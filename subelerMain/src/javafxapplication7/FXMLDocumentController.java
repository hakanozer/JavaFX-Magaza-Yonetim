...
//        });
    ...
    public void tabloDoldur() {
        ...
        mid.setCellValueFactory(new PropertyValueFactory<Terziler, String>("mudurID"));
        tadi.setCellValueFactory(new PropertyValueFactory<Terziler, String>("tAdi"));
        tsoyadi.setCellValueFactory(new PropertyValueFactory<Terziler, String>("tSoyadi"));
        ttelefon.setCellValueFactory(new PropertyValueFactory<Terziler, String>("tTelefonu"));
        tcep.setCellValueFactory(new PropertyValueFactory<Terziler, String>("tCep"));
        tadres.setCellValueFactory(new PropertyValueFactory<Terziler, String>("tAdres"));
        ttarih.setCellValueFactory(new PropertyValueFactory<Terziler, Date>("tTarih"));
...
//        System.out.println(list);
    ...
    @FXML
    private void kapat(ActionEvent event) throws IOException {
