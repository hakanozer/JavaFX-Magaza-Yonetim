...
public class UrunProperty {
    ...
    private int adet;
    private int sepetID;
    private boolean silButon;

    public boolean isSilButon() {
        return silButon;
    }

    public void setSilButon(boolean silButon) {
    ...
    public UrunProperty(int renkID, int urunID, int superID, int sezonID, int bedenID, String uTarih, String uAdi, String uResim, String barkodNo, BigDecimal uFiyat, String uKisaAciklama, String renk) {
        this.renkID = renkID;
        this.urunID = urunID;
