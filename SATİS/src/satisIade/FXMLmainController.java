...
public class FXMLmainController implements Initializable {
   ...
   SatisEkrani.DB faturaIslem =new SatisEkrani.DB();
    ...
    public void faturaUrunleriniGetir(ActionEvent event) {
        ...
        try {
            ...
            int i = 0;
            if(rs.wasNull())JOptionPane.showMessageDialog(null, "Böyle bir ürün yoktur");
 ...
 if(a.equals("no"))JOptionPane.showMessageDialog(null, "Böyle bir ürün yoktur");
        } catch (Exception e) {
